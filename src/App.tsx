...
function App() {
  ...
  return (
    <div>
      ...
      {!isOpen && (
        <button
          className="fixed top-75 right-6 flex items-center justify-center bg-gray-600 text-gray-200 w-14 h-14 rounded-full shadow-lg hover:bg-gray-500 transition cursor-pointer z-50"
